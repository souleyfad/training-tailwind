      ...
      <div className="mt-8 flex justify-center px-4">
        <div className="flex gap-2 w-full max-w-sm md:max-w-md bg-white rounded-full shadow items-center p-2 md:p-4 h-14 md:h-18">
          <input
            ...
            className="flex-grow min-w-0 bg-transparent text-sm outline-none text-gray-800 placeholder-gray-400 px-2"
          />
          <button
            className="flex-shrink-0 h-10 px-3 md:px-4 text-sm font-medium border border-[#BC208E] text-[#BC208E] bg-white hover:bg-[#BC208E] hover:text-white rounded-full transition whitespace-nowrap"
          >
            Rechercher
          </button>
        </div>
